...
bool Initialize(size_t argc, LPCTSTR* argv)
{
	...
	config.add_options()
        ...
        ("svm-file,s", boost::program_options::value<std::string>(&OPT::strSVMFileName), "SVM File from OpenCV to cut the mesh")
        ("label,l", boost::program_options::value<int>(&OPT::nLabel)->default_value(0), "label of the cluster (def. 0)")
        ;
	...
	if (OPT::strOutputFileName.IsEmpty())
		OPT::strOutputFileName = Util::getFileFullName(OPT::strInputFileName) + _T("_cut.mvs");

    	// initialize optional options
	Util::ensureValidPath(OPT::strSVMFileName);
	Util::ensureUnifySlash(OPT::strSVMFileName);
	if (OPT::strSVMFileName.IsEmpty())
        return false;
...
int main(int argc, LPCTSTR* argv)
{
    ...
    scene.SVMCutMesh(OPT::strSVMFileName, OPT::nLabel);
